...
CREATE INDEX ON quick_launch_user_defaults (user_id);
CREATE INDEX ON quick_launch_user_defaults (app_id);
CREATE INDEX ON quick_launch_user_defaults (quick_launch_id);
